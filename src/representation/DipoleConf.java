...
//		this.pieces[5] = 0x1400L;
//		this.pBlack = 0x1400L;
//		this.pieces[0] = 0x8L;
//		this.pRed = 0x8L;
		
//		this.pieces[5] = 0x28000000000000L;
//		this.pRed = 0x28000000000000L;
//		this.pieces[0] = 0x1000000000000000L;
//		this.pBlack = 0x1000000000000000L;
//		this.black = false;
...
//	 notFreeSquare); return ret; }
	...
	public int nullMoveEnc() {
		...
		if (!black) {
			pawn = pRed & -pRed;
			return new DipoleMove().encodingMove(Board.getSquare(pawn), Board.getSquare(pawn), 0, 0, false,
					typeMove.QUIETMOVE);
		} else {
			pawn = pBlack & -pBlack;
			return new DipoleMove().encodingMove(Board.getSquare(pawn), Board.getSquare(pawn), 0, 0, true,
					typeMove.QUIETMOVE);
		}
	}
