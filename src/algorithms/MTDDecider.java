...
public class MTDDecider implements AlgorithmInterface {
	...
	private Map<Conf, SearchNode> transpositionTable;
	...
	public Move compute(Conf conf) {
		...
		transpositionTable = new HashMap<Conf, SearchNode>(10000);
		return iterative_deepening(conf);
	}
	 ...
	 */
	private Move iterative_deepening(Conf root) {
