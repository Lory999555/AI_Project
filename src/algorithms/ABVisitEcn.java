...
import algorithms.ABWMVisit.Ply;
 ...
 */
public class ABVisitEcn implements AlgorithmInterfaceEnc {
	...
	public ABVisitEcn(HeuristicInterface hi, boolean blackPlayer, int startDepth, int maxDepth) {
