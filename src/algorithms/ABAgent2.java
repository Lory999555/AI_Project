...
// */
//public class ABAgent2 implements AlgorithmInterface {
//
...
//	};
//
//	public ABAgent2(HeuristicInterface hi, boolean blackPlayer, int startDepth, int maxDepth) {
...
//	private  
//
//	private MoveValue preCompute(Conf conf, Move move, int alpha, int beta, int depth, Ply step) {
//		searchednodes++;
//		Move bestMove = null;
