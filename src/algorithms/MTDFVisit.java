...
public class MTDFVisit implements AlgorithmInterface {
	...
	private ABVisit ab_R;
	private ABVisit ab_B;

	public MTDFVisit(HeuristicInterface hi, boolean blackPlayer, int startDepth, int maxDepth) {
		...
		ab_R= new ABVisit(hi, false, startDepth,startDepth );
		ab_B= new ABVisit(hi, true, startDepth,startDepth );
	}
